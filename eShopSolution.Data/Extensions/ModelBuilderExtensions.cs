    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                new Category()
                {
                    Id = 1, //PK is required when seeding
                    IsShowOnHome = true,
                    ParentId = null,
                    SortOrder = 1,
                ...
                new Category()
                {
                    Id = 2, //PK is required when seeding
                    IsShowOnHome = true,
                    ParentId = null,
                    SortOrder = 2,
                    Status = Status.Active
            ...
            modelBuilder.Entity<CategoryTranslation>().HasData(
                ...
                new CategoryTranslation() 
                { 
                    Id = 3, //PK is required when seeding
                    CategoryId = 2, 
                    Name = "Áo nữ", 
                    LanguageId = "vi", 
                    SeoAlias = "ao-nu", 
                ...
                new CategoryTranslation() 
                { 
                    Id = 4, //PK is required when seeding
                    CategoryId = 2, 
                    Name = "Women Shirt", 
                    LanguageId = "en", 
            ...
            var roleId = new Guid("853DA3A3-7D54-4076-934E-219F177975C6");
            var adminId = new Guid("8A7EA03E-6009-4F61-B250-17257FFA001C");
